...
def create_symbol_table(symbol):
    ...
    sql = "CREATE TABLE IF NOT EXISTS {} \
        (\
            ...
            finviz_recom TEXT,\
            finviz_tp INTERGER,\
            tipranks_tp INTERGER,\
            tipranks_tp_percent INTERGER,\
            tipranks_smart_string TEXT, \
            tipranks_smart_score INTERGER,\
            tipranks_fundementals TEXT,\
            tipranks_sediment TEXT,\
            cp INTERGER\
        )".format(symbol)
    cursor.execute(sql)
    connection.commit()
...
def update_row(data,symbol,date ):
    ...
    sql = "UPDATE {} set \
            ...
            tipranks_tp = {},\
            tipranks_tp_percent = {},\
            tipranks_smart_string = '{}',\
            tipranks_smart_score = {},\
            tipranks_fundementals = '{}',\
            tipranks_sediment = '{}',\
        ...
        .format(\
            ...
            data['finviz_tp'],\
            data['tipranks_tp'],\
            data['tipranks_tp_percent'],\
            data['tipranks_smart_string'],\
            data['tipranks_smart_score'],\
            data['tipranks_fundementals'],\
            data['tipranks_sediment'],\
            data['cp'],\
            date\
        )
    cursor.execute(sql)
